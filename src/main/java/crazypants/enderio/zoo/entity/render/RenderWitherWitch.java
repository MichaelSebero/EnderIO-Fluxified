...
public class RenderWitherWitch extends RenderLiving<EntityWitherWitch> {
    ...
    private static final ResourceLocation witchTextures = new ResourceLocation(EnderIOZoo.DOMAIN,
            "entity/wither_witch.png");
    ...
    @Override
    public void doRender(@Nonnull EntityWitherWitch p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
    ...
    public static class LayerHeldItemWitch implements LayerRenderer<EntityWitherWitch> {
        ...
        @Override
        public void doRenderLayer(@Nonnull EntityWitherWitch entitylivingbaseIn, float p_177141_2_, float p_177141_3_,
                                  float partialTicks, float p_177141_5_,
            ...
            if (Prep.isValid(itemstack)) {
                ...
                // minecraft.getBlockRendererDispatcher().isEntityBlockAnimated(Block.getBlockFromItem(item))) {
