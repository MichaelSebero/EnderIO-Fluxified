...
public class ModelOwl extends ModelBase {
    ...
    public final @Nonnull ModelRenderer body, head, legL, legR, tailBase, footL, footR, wingR, wingL, earL, earR, beak,
            tail1, tail2, tail3;
    ...
    @Override
    public void render(@Nonnull Entity entity, float time, float limbSwing, float f2, float headY, float headX,
                       float scale) {
    ...
    @Override
    public void setRotationAngles(float limbSwing1, float limbSwing2, float rotationAngle, float headY, float headX,
                                  float yOffset, @Nonnull Entity entity) {
