...
public class RenderEnderminy extends RenderLiving<EntityEnderminy> {
    ...
    private static final @Nonnull ResourceLocation endermanEyesTexture = new ResourceLocation(EnderIOZoo.DOMAIN,
            "entity/enderminy_eyes.png");
    private static final @Nonnull ResourceLocation endermanTextures = new ResourceLocation(EnderIOZoo.DOMAIN,
            "entity/enderminy.png");
    ...
    @Override
    public void doRender(@Nonnull EntityEnderminy p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
    ...
    private class EyesLayer implements LayerRenderer<EntityEnderminy> {
        ...
        @Override
        public void doRenderLayer(@Nonnull EntityEnderminy em, float p_177201_2_, float p_177201_3_, float p_177201_4_,
                                  float p_177201_5_, float p_177201_6_,
