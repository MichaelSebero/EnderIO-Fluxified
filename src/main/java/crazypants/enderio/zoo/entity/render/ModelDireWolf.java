...
public class ModelDireWolf extends ModelBase {
     ...
     */
    @Override
    public void render(@Nonnull Entity entity, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_,
    ...
    @Override
    public void setLivingAnimations(@Nonnull EntityLivingBase entity, float p_78086_2_, float p_78086_3_,
                                    float p_78086_4_) {
