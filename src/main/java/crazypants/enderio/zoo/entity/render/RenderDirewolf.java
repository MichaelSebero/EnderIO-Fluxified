...
public class RenderDirewolf extends RenderLiving<EntityDireWolf> {
    ...
    @Override
    protected float handleRotationFloat(@Nonnull EntityDireWolf wolf, float p_77044_2_) {
        return wolf.getTailRotation();
    }

    @Override
    protected void preRenderCallback(@Nonnull EntityDireWolf entity, float partialTick) {
        if (debugCounter == 4) {
    ...
    @Override
    public void doRender(@Nonnull EntityDireWolf entity, double x, double y, double z, float p_76986_8_,
                         float p_76986_9_) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(@Nonnull EntityDireWolf p_110775_1_) {
        return wolfTextures;
    }
