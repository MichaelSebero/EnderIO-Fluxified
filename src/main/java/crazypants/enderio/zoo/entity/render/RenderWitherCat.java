...
public class RenderWitherCat extends RenderLiving<EntityWitherCat> {
    ...
    private @Nonnull ResourceLocation angryTexture = new ResourceLocation(EnderIOZoo.DOMAIN,
            "entity/wither_cat_angry.png");
    ...
    @Override
    public void doRender(@Nonnull EntityWitherCat entity, double x, double y, double z, float p_76986_8_,
                         float p_76986_9_) {
    ...
    private class AngryLayer implements LayerRenderer<EntityWitherCat> {
        ...
        @Override
        public void doRenderLayer(@Nonnull EntityWitherCat cat, float p_177201_2_, float p_177201_3_, float p_177201_4_,
            ...
            if (blendFactor > 0) {
                ...
                getMainModel().render(cat, p_177201_2_, p_177201_3_, p_177201_5_, p_177201_6_, p_177201_7_,
                        p_177201_8_);
                setLightmap(cat);
            }
        }
