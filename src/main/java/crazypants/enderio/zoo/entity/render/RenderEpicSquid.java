...
public class RenderEpicSquid extends RenderLiving<EntityEpicSquid> {
    ...
    private static final @Nonnull ResourceLocation EPIC_TEXTURES = new ResourceLocation(EnderIOZoo.DOMAIN,
            "entity/epicsquid.png");
    ...
    @Override
    protected void applyRotations(@Nonnull EntityEpicSquid entityLiving, float p_77043_2_, float rotationYaw,
                                  float partialTicks) {
    ...
    @Override
    protected boolean setBrightness(@Nonnull EntityEpicSquid entitylivingbaseIn, float partialTicks,
