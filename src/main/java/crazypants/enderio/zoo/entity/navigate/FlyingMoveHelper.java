    ...
    public void onUpdateMoveHelper() {
        if (!entity.getNavigator().noPath()) {
            ...
            float moveSpeed = (float) (speed *
                    entity.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getAttributeValue());
            ...
            entity.getLookHelper().setLookPosition(lookX + (d7 - lookX) * 0.125D, lookY + (d8 - lookY) * 0.125D,
                    lookZ + (d9 - lookZ) * 0.125D, 10.0F, 40.0F);
        } else {
