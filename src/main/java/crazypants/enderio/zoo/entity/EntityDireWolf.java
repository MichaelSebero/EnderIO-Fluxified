...
public class EntityDireWolf extends EntityMob implements IEnderZooEntity.Aggressive {
    ...
    private static final @Nonnull DataParameter<Boolean> ANGRY_INDEX = EntityDataManager
            .<Boolean>createKey(EntityDireWolf.class, DataSerializers.BOOLEAN);
    ...
    public EntityDireWolf(World world) {
        ...
        targetTasks.addTask(2,
                new EntityAINearestAttackableTargetBounded<EntityPlayer>(this, EntityPlayer.class, true)
                        .setMaxDistanceToTarget(ZooConfig.wolfAggressionRange));
    }
    ...
    protected SoundEvent getAmbientSound() {
        ...
        boolean howl = (packHowl > 0 || rand.nextFloat() <= ZooConfig.howlChance.get()) &&
                world.getTotalWorldTime() > (lastHowl + 10);
        if (howl) {
