...
public class EntityOwl extends EntityAnimal implements IEnderZooEntity.Flying {
    ...
    public EntityOwl(World worldIn) {
        ...
        EntityAINearestAttackableTargetBounded<EntitySpider> targetSpiders = new EntityAINearestAttackableTargetBounded<EntitySpider>(
                this, EntitySpider.class,
                true, true);
    ...
    public void playLivingSound() {
        ...
        playSound(getAmbientSound(), getSoundVolume() * ZooConfig.owlHootVolumeMultiplier.get(),
                0.8f * getSoundPitch());
    }
