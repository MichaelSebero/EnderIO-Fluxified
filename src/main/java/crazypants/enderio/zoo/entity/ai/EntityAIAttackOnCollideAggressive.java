...
public class EntityAIAttackOnCollideAggressive extends EntityAIBase {
    ...
    public EntityAIAttackOnCollideAggressive(EntityLiving attacker, Class<?> targetClass, double attackSpeed,
                                             boolean longMemory) {
    ...
    public boolean shouldContinueExecuting() {
        ...
        return entitylivingbase == null ? false :
                (!entitylivingbase.isEntityAlive() ? false :
                        (!longMemory ? !attacker.getNavigator().noPath() : attacker instanceof EntityCreature ?
                                ((EntityCreature) attacker).isWithinHomeDistanceCurrentPosition() : true));
    }
    ...
    public void updateTask() {
        ...
        double distToTargetSq = attacker.getDistanceSq(entitylivingbase.posX,
