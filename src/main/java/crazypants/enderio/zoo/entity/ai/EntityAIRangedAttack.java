...
public class EntityAIRangedAttack extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        final double distToTargetSq = entityHost.getDistanceSq(attackTarget.posX,
                attackTargetNN.getEntityBoundingBox().minY, attackTarget.posZ);
        ...
        if (--timeUntilNextAttack <= 0) {
            ...
            timeUntilNextAttack = MathHelper
                    .floor(rangeRatio * (maxRangedAttackTime - minRangedAttackTime) + minRangedAttackTime);
        }
    }
}
