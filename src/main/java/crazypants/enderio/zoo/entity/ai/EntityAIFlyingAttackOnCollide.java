...
public class EntityAIFlyingAttackOnCollide extends EntityAIBase {
    ...
    public EntityAIFlyingAttackOnCollide(IEnderZooEntity.Flying mob, Class<? extends Entity> targetClass,
                                         double speedIn, boolean useLongMemory) {
    ...
    public boolean shouldContinueExecuting() {
        ...
        return !longMemory ? !attacker.getNavigator().noPath() :
                attacker.isWithinHomeDistanceFromPosition(new BlockPos(target));
    }
    ...
    public void updateTask() {
        ...
        double distToTargSq = attacker.getDistanceSq(entitylivingbase.posX,
    ...
    private boolean flyToAttacker(EntityLivingBase targetEnt) {
        ...
        return flyingMob.getFlyingNavigator().tryFlyToPos(targetEnt.posX, targBB.maxY + 0.5, targetEnt.posZ,
                speedTowardsTarget);
    }
