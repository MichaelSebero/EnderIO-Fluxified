...
public class SpawnUtil {
    ...
    public static BlockPos findClearGround(@Nonnull World world, @Nonnull BlockPos startingLocation, int horizRange,
                                           int vertRange,
                                           boolean checkForLivingEntities) {
        for (PlanarBlockIterator itr = new PlanarBlockIterator(startingLocation, Orientation.EAST_WEST, horizRange); itr
                .hasNext();) {
    ...
    public static BlockPos seachYForClearGround(@Nonnull BlockPos startingLocation, @Nonnull World world,
                                                int searchRange, boolean checkForLivingEntities) {
    ...
    public static boolean isSpaceAvailableForSpawn(World worldObj, EntityCreature entityCreature,
    ...
    public static boolean isSpaceAvailableForSpawn(World worldObj, EntityLiving entity, boolean checkEntityCollisions,
                                                   boolean canSpawnInLiquid) {
        return isSpaceAvailableForSpawn(worldObj, entity,
                entity instanceof EntityCreature ? ((EntityCreature) entity) : null, checkEntityCollisions,
                canSpawnInLiquid);
    }
