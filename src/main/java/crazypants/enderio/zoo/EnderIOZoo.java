...
@Mod(modid = EnderIOZoo.MODID,
     name = EnderIOZoo.MOD_NAME,
     version = EnderIOZoo.VERSION,
     dependencies = EnderIOZoo.DEPENDENCIES)
@EventBusSubscriber
public class EnderIOZoo implements IEnderIOAddon {
    ...
    @SidedProxy(clientSide = "crazypants.enderio.zoo.init.ClientProxy",
                serverSide = "crazypants.enderio.zoo.init.CommonProxy")
    ...
    public NNList<Triple<Integer, RecipeFactory, String>> getRecipeFiles() {
        return new NNList<>(Triple.of(2, null, "spawner_zoo"), Triple.of(4, null, "potions_zoo"),
                Triple.of(4, null, "hiding_zoo"));
    }
}
