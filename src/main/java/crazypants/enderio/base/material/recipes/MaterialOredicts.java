...
public class MaterialOredicts {
    ...
    static final String[] dyes = { "Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan", "LightGray", "Gray",
            "Pink", "Lime", "Yellow", "LightBlue",
    ...
    public static void registerOredict(@Nonnull RegistryEvent.Register<Item> event) {
        ...
        registerOre("blockGlass",
                new ItemStack(FusedQuartzType.FUSED_GLASS.getBlock(), 1, OreDictionary.WILDCARD_VALUE));
        registerOre("blockGlassColorless",
                new ItemStack(FusedQuartzType.FUSED_GLASS.getBlock(), 1, EnumDyeColor.WHITE.getMetadata()));
        registerOre("blockGlassHardened",
                new ItemStack(FusedQuartzType.FUSED_QUARTZ.getBlock(), 1, OreDictionary.WILDCARD_VALUE));

        for (int i = 0; i < dyes.length; i++) {
            registerOre("blockGlass" + dyes[i], new ItemStack(FusedQuartzType.FUSED_GLASS.getBlock(), 1,
                    EnumDyeColor.byDyeDamage(i).getMetadata()));
            registerOre("blockGlassHardened" + dyes[i], new ItemStack(FusedQuartzType.FUSED_QUARTZ.getBlock(), 1,
                    EnumDyeColor.byDyeDamage(i).getMetadata()));
        }
        ...
        registerOre("toolShears",
                new ItemStack(ModObject.itemDarkSteelShears.getItemNN(), 1, OreDictionary.WILDCARD_VALUE));

        // Treetap
        registerOre("toolTreetap",
                new ItemStack(ModObject.itemDarkSteelTreetap.getItemNN(), 1, OreDictionary.WILDCARD_VALUE));
