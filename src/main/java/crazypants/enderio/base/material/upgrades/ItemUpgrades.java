...
public final class ItemUpgrades extends Item implements IHaveRenderers, IAdvancedTooltipProvider {
  ...
  protected @Nonnull ModelResourceLocation getMRL(final ResourceLocation base, final @Nonnull ResourceLocation registryName) {
    return new ModelResourceLocation(new ResourceLocation(registryName.getNamespace(), base.getPath()),
        "upgrade=" + registryName.getPath());
  }
  ...
  public @Nonnull String getItemStackDisplayName(@Nonnull ItemStack stack) {
    IDarkSteelUpgrade upgrade = getUpgrade(stack);
    if (upgrade != null) {
      return I18n.translateToLocalFormatted(getTranslationKey() + ".with", super.getItemStackDisplayName(stack)).trim();
    } else {
  ...
  public void addCommonEntries(@Nonnull ItemStack itemstack, @Nullable EntityPlayer entityplayer, @Nonnull List<String> list, boolean flag) {
    SpecialTooltipHandler.addCommonTooltipFromResources(list, itemstack.getTranslationKey());
  }

  @Override
  public void addBasicEntries(@Nonnull ItemStack itemstack, @Nullable EntityPlayer entityplayer, @Nonnull List<String> list, boolean flag) {
    SpecialTooltipHandler.addBasicTooltipFromResources(list, itemstack.getTranslationKey());
  }
  ...
  public void addDetailedEntries(@Nonnull ItemStack itemstack, @Nullable EntityPlayer entityplayer, @Nonnull List<String> list, boolean flag) {
    ...
    if (upgrade != null) {
      ...
      SpecialTooltipHandler.addDetailedTooltipFromResources(list, getTranslationKey());
    }
  }
