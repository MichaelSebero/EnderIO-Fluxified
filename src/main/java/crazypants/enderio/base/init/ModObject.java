...
public enum ModObject implements IModObjectBase {
    ...
    block_holier_fog(BlockHolierFog::create),
    ...
    blockPaintedSlab(BlockPaintedSlabManager::create_wood, BlockPaintedSlabManager::create_item,
            ModTileEntity.TileEntityPaintedBlock),
    blockPaintedDoubleSlab(BlockPaintedSlabManager::create_wood_double, (mo, b) -> null,
            ModTileEntity.TileEntityTwicePaintedBlock),
    blockPaintedStoneSlab(BlockPaintedSlabManager::create_stone, BlockPaintedSlabManager::create_item,
            ModTileEntity.TileEntityPaintedBlock),
    blockPaintedStoneDoubleSlab(BlockPaintedSlabManager::create_stone_double, null,
            ModTileEntity.TileEntityTwicePaintedBlock),
    ...
    blockPaintedReinforcedObsidianNonsolid(BlockPaintedReinforcedObsidian::create,
            ModTileEntity.TileEntityPaintedBlock),
    ...
    blockNotPastureEnlightenedFusedQuartz(
            BlockFusedQuartz.create(FusedQuartzType.NOT_PASTURE_ENLIGHTENED_FUSED_QUARTZ)),
    ...
    blockPaintedFusedQuartz(BlockPaintedFusedQuartz.create(FusedQuartzType.KIND0),
            ModTileEntity.TileEntityPaintedBlock),
    blockPaintedFusedQuartz1(BlockPaintedFusedQuartz.create(FusedQuartzType.KIND1),
            ModTileEntity.TileEntityPaintedBlock),
    blockPaintedFusedQuartz2(BlockPaintedFusedQuartz.create(FusedQuartzType.KIND2),
            ModTileEntity.TileEntityPaintedBlock),
    ...
    private ModObject(@Nullable Function<IModObject, Block> blockMaker,
