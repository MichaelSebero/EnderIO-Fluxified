...
public class Entity implements IRecipeConfigElement {
  ...
  private static class ResourceLocationMatcher implements Predicate<ResourceLocation> {
    ...
    public boolean test(@Nullable ResourceLocation t) {
      return t != null //
          && (modid == null || t.getNamespace().equals(modid)) //
          && (modidPre == null || t.getNamespace().startsWith(modidPre)) //
          && (modidPost == null || t.getNamespace().endsWith(modidPost)) //
          && (id == null || t.getNamespace().equals(id)) //
          && (pre == null || t.getNamespace().startsWith(pre)) //
          && (post == null || t.getNamespace().endsWith(post));
    }
  }
