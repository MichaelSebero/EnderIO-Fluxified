...
public class ItemDarkSteelShield extends ItemShield
  ...
  public @Nonnull String getItemStackDisplayName(@Nonnull ItemStack stack) {
    if (stack.getSubCompound("BlockEntityTag") != null) {
      ...
      return EnderIO.lang.localizeExact(getTranslationKey(stack) + "." + enumdyecolor.getTranslationKey() + DOT_COM);
    } else {
      return EnderIO.lang.localizeExact(getTranslationKey(stack) + DOT_COM);
    }
  }
