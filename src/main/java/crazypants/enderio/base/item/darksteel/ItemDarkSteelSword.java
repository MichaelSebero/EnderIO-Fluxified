...
public class ItemDarkSteelSword extends ItemSword implements IAdvancedTooltipProvider, IDarkSteelItem, IItemOfTravel,
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(@Nonnull EntityEquipmentSlot equipmentSlot,
        ...
        if (equipmentSlot == EntityEquipmentSlot.MAINHAND) {
            if (DarkSteelConfig.darkSteelSwordPowerUsePerHit.get() <= 0 ||
                ...
                res.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(),
                        DarkSteelAttributeModifiers.getAttackDamage(level));
                res.put(SharedMonsterAttributes.ATTACK_SPEED.getName(),
                        DarkSteelAttributeModifiers.getAttackSpeed(level));
            }
        }
        return res;
    }
    ...
    @Override
    public boolean hitEntity(@Nonnull ItemStack stack, @Nonnull EntityLivingBase entity,
                             @Nonnull EntityLivingBase playerEntity) {
