...
public class TeleportUtil {
    ...
    public static boolean doTeleport(@Nonnull Entity entityLiving, @Nonnull BlockPos pos, int targetDim,
                                     boolean conserveMotion, @Nonnull TravelSource source) {
    ...
    public static boolean checkClientTeleport(@Nonnull Entity entityLiving, @Nonnull BlockPos pos, int targetDim,
    ...
    public static boolean serverTeleport(@Nonnull Entity entity, @Nonnull BlockPos pos, int targetDim,
                                         boolean conserveMotion, @Nonnull TravelSource source) {
    ...
    private static void serverEntityLocalTeleport(@Nonnull Entity entity, @Nonnull BlockPos pos,
                                                  @Nonnull TravelSource source) {
    ...
    private static void serverPlayerLocalTeleport(@Nonnull EntityPlayerMP player, @Nonnull BlockPos pos,
                                                  boolean conserveMotion, @Nonnull TravelSource source) {
    ...
    private static void serverEntityDimensionTeleport(@Nonnull Entity entity, @Nonnull BlockPos pos, int targetDim,
                                                      @Nonnull TravelSource source) {
        SoundHelper.playSound(entity.world, entity, source.sound, 1.0F, 1.0F);
        entity.changeDimension(targetDim, new ITeleporter() {
            ...
            public void placeEntity(World world, Entity entity2, float yaw) {
                entity2.setLocationAndAngles(pos.getX() + 0.5, pos.getY() + 1.1, pos.getZ() + 0.5, entity2.rotationYaw,
    ...
    private static void serverPlayerDimensionTeleport(@Nonnull final EntityPlayerMP player, @Nonnull final BlockPos pos,
                                                      final int targetDim,
                                                      final boolean conserveMotion,
                                                      @Nonnull final TravelSource source) {
        ChunkTicket.loadChunk(player, player.world, BlockCoord.get(player));
        SoundHelper.playSound(player.world, player, source.sound, 1.0F, 1.0F);

        player.server.getPlayerList().transferPlayerToDimension(player, targetDim, new ITeleporter() {
