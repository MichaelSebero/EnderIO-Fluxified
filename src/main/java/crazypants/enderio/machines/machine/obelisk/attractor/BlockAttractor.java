...
public class BlockAttractor extends AbstractBlockRangedObelisk<TileAttractor> {
  ...
  public void init(@Nonnull IModObject object, @Nonnull FMLInitializationEvent event) {
    ...
    permissionAttracting = PermissionAPI.registerNode(EnderIO.DOMAIN + ".attract." + this.getTranslationKey().toLowerCase(Locale.ENGLISH),
        DefaultPermissionLevel.ALL, "Permission for the block " + this.getTranslationKey() + " of Ender IO to attract entities."
