...
public enum CapacitorKey implements ICapacitorKey {
  ...
  COMBUSTION_POWER_SEND(MachineObject.block_combustion_generator, CapacitorKeyType.ENERGY_INTAKE, "send"),
  ...
  ENHANCED_COMBUSTION_POWER_SEND(MachineObject.block_enhanced_combustion_generator, CapacitorKeyType.ENERGY_INTAKE, "send"),
  ...
  NIARD_POWER_INTAKE(MachineObject.block_niard, CapacitorKeyType.ENERGY_INTAKE, "intake"),
  NIARD_POWER_BUFFER(MachineObject.block_niard, CapacitorKeyType.ENERGY_BUFFER, "buffer"),
  NIARD_POWER_USE(MachineObject.block_niard, CapacitorKeyType.ENERGY_USE, "use"),
  NIARD_RANGE(MachineObject.block_niard, CapacitorKeyType.AREA, "range"),
  NIARD_DELAY(MachineObject.block_niard, CapacitorKeyType.AMOUNT, "delay"),
  NIARD_POWER_WORK(MachineObject.block_niard, CapacitorKeyType.AMOUNT, "work"),
  ...
  private CapacitorKey(@Nonnull IModObject owner, @Nonnull CapacitorKeyType valueType, @Nonnull String shortname) {
    ...
    this.registryName = new ResourceLocation(owner.getRegistryName().getNamespace(),
        owner.getRegistryName().getPath() + "/" + shortname.toLowerCase(Locale.ENGLISH));
  }
