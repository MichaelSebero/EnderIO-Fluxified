...
public class GasConduits implements IEnderIOAddon {
    ...
    public boolean checkModLists(Map<String, String> modList, Side side) {
         ...
         *
         * On the integrated server when a client connects: Require the mod to be there and of the same version. Ugly
         * error message.
         */
        return modList.keySet().contains(GasConduitsConstants.MOD_ID) &&
                GasConduitsConstants.VERSION.equals(modList.get(GasConduitsConstants.MOD_ID));
    }
